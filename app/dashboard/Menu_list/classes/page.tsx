...
const renderRow = (item: ClassList) => (
  ...
  >
    ...
    <td className="hidden lg:table-cell px-4 py-2 text-gray-700">{item.capacity}</td>
    <td className="hidden lg:table-cell px-4 py-2 text-gray-700">{item.supervisor}</td>
...
const classList = () => {
    ...
    return (
        ...
        <div>
                <Table col= {col} renderRow ={renderRow} data ={classesData}/>
            </div>
         <Pagination />
         </div>
    )
